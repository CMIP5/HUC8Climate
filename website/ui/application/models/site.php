...
class Site extends MY_Model
{
	...
	function displayAllHUC()
	{	
	$result = $this->db->query('SELECT SiteID, SiteCode, SiteName, Latitude, Longitude, SiteType, "1" as `SourceID`, "USGS" as `Organization`, "USGS" as `SourceLink`, NULL as `picname` FROM sites ORDER BY SiteName');
