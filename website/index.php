...
$WorldWater = "Yes"; //Use "Yes" If this is on world water servers. 
$MainDir = "main"; //This is the location to the main directory where all the files are contained on the server. 
